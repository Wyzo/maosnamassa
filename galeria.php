        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-4 mb-3">
                    <img src="./imagens/galeria/1.png" alt="" class="fluid img-thumbnail">
                </div>
                <div class="col-sm-6 col-md-4 mb-3">
                    <img src="./imagens/galeria/2.png" alt="" class="fluid img-thumbnail">
                </div>
                <div class="col-sm-6 col-md-4 mb-3">
                    <img src="./imagens/galeria/5.png" alt="" class="fluid img-thumbnail">
                </div>
                <div class="col-sm-6 col-md-4 mb-3">
                    <img src="./imagens/galeria/4.png" alt="" class="fluid img-thumbnail">
                </div>
                <div class="col-sm-6 col-md-4 mb-3">
                    <img src="./imagens/galeria/5.png" alt="" class="fluid img-thumbnail">
                </div>
                <div class="col-sm-6 col-md-4 mb-3">
                    <img src="./imagens/galeria/6.png" alt="" class="fluid img-thumbnail">
                </div>
            </div>
        </div>
    </div>
